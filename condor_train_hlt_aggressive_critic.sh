...
echo "==== HLT NURD contrastive training (aggressive critic) started: $(date) ===="
echo "Host: $(hostname)"
...
$PYTHON train_hlt.py \
    ...
    --_lambda      0.01 \
    --no_mi_norm \
    --exp_name     hlt_nurd_aggressive_critic \
    --project_name hlt \
    --manualSeed   42

echo "==== HLT NURD contrastive training (aggressive critic) finished: $(date) ===="
