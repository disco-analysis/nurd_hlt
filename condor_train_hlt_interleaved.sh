...
echo "==== HLT NURD contrastive training (interleaved critic) started: $(date) ===="
echo "Host: $(hostname)"
...
$PYTHON train_hlt.py \
    ...
    --dim_ff       512 \
    --linear_dim   16 \
    --critic_schedule interleaved \
    --_lambda      0.01 \
    --exp_name     hlt_nurd_interleaved \
    --project_name hlt \
    --manualSeed   42

echo "==== HLT NURD contrastive training (interleaved critic) finished: $(date) ===="
